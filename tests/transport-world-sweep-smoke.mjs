...
// 3000,0 is outside every current LOWTOWN island and bridge.
car.state.x=3000;car.state.y=0;car.state.v=300;car.state.vx=300;car.state.vy=0;
...
console.log('TRANSPORT WORLD SWEEP: PASS ROAD MOTION + SEA GUARD + HARD STOP');
