...
for(let i=0;i<60;i++)delayed.step(1/60,{throttle:1,brake:0,steer:0});
...
assert(delayedPrediction.confidence>0&&delayedPrediction.confidence<=1);

console.log('PHYSICS PREDICTION: PASS SHARED KERNEL + LIVE CONTROL CADENCE + UNCERTAINTY');
