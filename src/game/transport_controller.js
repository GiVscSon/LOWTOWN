...
export function createTransportController(vehicleId='sedan',initial={}){
  ...
  function snapshot(){
    ...
    return {
      vehicleId:v.id,profile:v,typeProfile:t,state:{...state},physics:{...physics},input:{...lastInput},
      telemetry:transportTelemetry(state,lastInput)
    };
  }

  return {
    get vehicleId(){return currentId;},
    get profile(){return profile();},
    get typeProfile(){return getTransportTypeProfile(state.type);},
    get state(){return state;},
    get physics(){return physics;},
    setVehicle,control,step,snapshot
  };
}
