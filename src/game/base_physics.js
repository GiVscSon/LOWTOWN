...
export const BASE_PHYSICS = freeze({
  ...
  [TRANSPORT_TYPES.BOAT]: freeze({ type:'BOAT', engineForce:5000, reverseForce:3000, brakeForce:3200, lateralGrip:1.8, handbrakeGrip:1.8, drag:.997, handbrakeDrag:.997, steeringRate:.72, handbrakeSteeringRate:.72, rollingResistance:.008, aeroDrag:.00002, waterResistance:1, maxReverseSpeed:65 }),
