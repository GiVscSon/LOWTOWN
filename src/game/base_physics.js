...
export const BASE_PHYSICS = freeze({
  [TRANSPORT_TYPES.CAR]: freeze({ type:'CAR', engineForce:8000, reverseForce:4500, brakeForce:12000, lateralGrip:10.5, handbrakeGrip:2, drag:.9995, handbrakeDrag:.985, steeringRate:1.9, handbrakeSteeringRate:1.65, steeringAuthoritySpeed:55, rollingResistance:.0008, aeroDrag:.000012, yawInertia:2.4, yawDamping:5.5, slipAngleGrip:7.5, handbrakeSlipGrip:1.15, maxReverseSpeed:180, handlingModel:'auto', dynamicModelSpeed:260, dynamicBlendSpeed:45, wheelbase:2.7, corneringStiffness:3.2, maxLateralAccel:1.05 }),
