...
const FERRY_ROUTES = [
  { id:'LOWTOWN_IRON_FERRY', from:'LOWTOWN', to:'IRON_HARBOR', a:{x:640,y:-560}, b:{x:1120,y:-560}, speed:105 }
];
const AIR_ROUTES = [
  { id:'LOWTOWN_NORTH_AIR', from:'LOWTOWN', to:'NORTH_RIDGE', a:{x:120,y:620}, b:{x:300,y:1350}, speed:420 },
